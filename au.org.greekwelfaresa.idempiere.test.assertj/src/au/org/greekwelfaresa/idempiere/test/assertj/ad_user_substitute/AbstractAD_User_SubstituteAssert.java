...
package au.org.greekwelfaresa.idempiere.test.assertj.ad_user_substitute;
...
/** Generated assertion class for AD_User_Substitute
 *  @author idempiere-test (generated) 
 *  @version Release 6.2 - $Id$ */
@Generated("class au.org.greekwelfaresa.idempiere.test.generator.ModelAssertionGenerator")
public abstract class AbstractAD_User_SubstituteAssert<SELF extends AbstractAD_User_SubstituteAssert<SELF, ACTUAL>, ACTUAL extends X_AD_User_Substitute>
	extends AbstractPOAssert<SELF, ACTUAL>
{

    /** Standard Constructor */
    public AbstractAD_User_SubstituteAssert (ACTUAL actual, Class<SELF> selfType)
    {
	...
	public SELF hasAD_User_Substitute_ID(int expected)
	{
		isNotNull();
	...
	public SELF hasAD_User_Substitute_UU(String expected)
	{
		isNotNull();
