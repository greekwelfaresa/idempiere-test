...
package au.org.greekwelfaresa.idempiere.test.assertj.m_matchpo;
...
public abstract class AbstractM_MatchPOAssert<SELF extends AbstractM_MatchPOAssert<SELF, ACTUAL>, ACTUAL extends X_M_MatchPO>
	extends AbstractPOAssert<SELF, ACTUAL>
{

    /** Standard Constructor */
    public AbstractM_MatchPOAssert (ACTUAL actual, Class<SELF> selfType)
    {
	...
	public SELF hasM_MatchPO_ID(int expected)
	{
		isNotNull();
	...
	public SELF hasM_MatchPO_UU(String expected)
	{
		isNotNull();
	...
	public SELF hasPriceMatchDifference(Object expected)
	{
		isNotNull();
