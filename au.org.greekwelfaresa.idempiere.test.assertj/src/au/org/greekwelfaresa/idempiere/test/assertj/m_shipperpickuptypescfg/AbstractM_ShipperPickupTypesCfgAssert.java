...
package au.org.greekwelfaresa.idempiere.test.assertj.m_shipperpickuptypescfg;
...
public abstract class AbstractM_ShipperPickupTypesCfgAssert<SELF extends AbstractM_ShipperPickupTypesCfgAssert<SELF, ACTUAL>, ACTUAL extends X_M_ShipperPickupTypesCfg>
	extends AbstractPOAssert<SELF, ACTUAL>
{

    /** Standard Constructor */
    public AbstractM_ShipperPickupTypesCfgAssert (ACTUAL actual, Class<SELF> selfType)
    {
	...
	public SELF hasM_ShipperPickupTypesCfg_UU(String expected)
	{
		isNotNull();
