...
public abstract class AbstractFact_AcctAssert<SELF extends AbstractFact_AcctAssert<SELF, ACTUAL>, ACTUAL extends X_Fact_Acct>
	extends AbstractPOAssert<SELF, ACTUAL>
{

    /** Standard Constructor */
    public AbstractFact_AcctAssert (ACTUAL actual, Class<SELF> selfType)
    {
	...
	public SELF hasFact_Acct_UU(String expected)
	{
		isNotNull();
	...
	public SELF hasLine_ID(int expected)
	{
		isNotNull();
