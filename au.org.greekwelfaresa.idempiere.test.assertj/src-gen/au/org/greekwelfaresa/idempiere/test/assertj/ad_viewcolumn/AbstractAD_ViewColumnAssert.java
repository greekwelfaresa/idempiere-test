...
package au.org.greekwelfaresa.idempiere.test.assertj.ad_viewcolumn;
...
public abstract class AbstractAD_ViewColumnAssert<SELF extends AbstractAD_ViewColumnAssert<SELF, ACTUAL>, ACTUAL extends X_AD_ViewColumn>
	extends AbstractPOAssert<SELF, ACTUAL>
{

    /** Standard Constructor */
    public AbstractAD_ViewColumnAssert (ACTUAL actual, Class<SELF> selfType)
    {
      super (actual, selfType);
    }


	public SELF hasAD_ViewColumn_ID(int expected)
	{
		isNotNull();
	...
	public SELF hasAD_ViewColumn_UU(String expected)
	{
		isNotNull();
	...
	public SELF hasAD_ViewComponent_ID(int expected)
	{
		isNotNull();
	...
	public SELF hasDBDataType(String expected)
	{
		isNotNull();
