...
package au.org.greekwelfaresa.idempiere.test.assertj.ad_schedulerlog;
...
public abstract class AbstractAD_SchedulerLogAssert<SELF extends AbstractAD_SchedulerLogAssert<SELF, ACTUAL>, ACTUAL extends X_AD_SchedulerLog>
	extends AbstractPOAssert<SELF, ACTUAL>
{

    /** Standard Constructor */
    public AbstractAD_SchedulerLogAssert (ACTUAL actual, Class<SELF> selfType)
    {
	...
	public SELF hasAD_SchedulerLog_ID(int expected)
	{
		isNotNull();
	...
	public SELF hasAD_SchedulerLog_UU(String expected)
	{
		isNotNull();
