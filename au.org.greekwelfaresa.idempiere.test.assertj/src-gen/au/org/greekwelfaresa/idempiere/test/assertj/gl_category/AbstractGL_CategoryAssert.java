...
package au.org.greekwelfaresa.idempiere.test.assertj.gl_category;
...
public abstract class AbstractGL_CategoryAssert<SELF extends AbstractGL_CategoryAssert<SELF, ACTUAL>, ACTUAL extends X_GL_Category>
	extends AbstractPOAssert<SELF, ACTUAL>
{

    /** Standard Constructor */
    public AbstractGL_CategoryAssert (ACTUAL actual, Class<SELF> selfType)
    {
      super (actual, selfType);
    }


	public SELF hasCategoryType(String expected)
	{
		isNotNull();
	...
	public SELF hasGL_Category_UU(String expected)
	{
		isNotNull();
