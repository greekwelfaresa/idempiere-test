...
package au.org.greekwelfaresa.idempiere.test.assertj.cm_media;
...
public abstract class AbstractCM_MediaAssert<SELF extends AbstractCM_MediaAssert<SELF, ACTUAL>, ACTUAL extends X_CM_Media>
	extends AbstractPOAssert<SELF, ACTUAL>
{

    /** Standard Constructor */
    public AbstractCM_MediaAssert (ACTUAL actual, Class<SELF> selfType)
    {
	...
	public SELF hasCM_Media_UU(String expected)
	{
		isNotNull();
	...
	public SELF hasMediaType(String expected)
	{
		isNotNull();
