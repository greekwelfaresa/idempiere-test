...
package au.org.greekwelfaresa.idempiere.test.assertj.ad_task_access;
...
public abstract class AbstractAD_Task_AccessAssert<SELF extends AbstractAD_Task_AccessAssert<SELF, ACTUAL>, ACTUAL extends X_AD_Task_Access>
	extends AbstractPOAssert<SELF, ACTUAL>
{

    /** Standard Constructor */
    public AbstractAD_Task_AccessAssert (ACTUAL actual, Class<SELF> selfType)
    {
	...
	public SELF hasAD_Task_Access_UU(String expected)
	{
		isNotNull();
