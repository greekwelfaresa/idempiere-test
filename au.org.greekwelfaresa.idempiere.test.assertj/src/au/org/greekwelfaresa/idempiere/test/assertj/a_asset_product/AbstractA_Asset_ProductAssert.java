...
package au.org.greekwelfaresa.idempiere.test.assertj.a_asset_product;
...
public abstract class AbstractA_Asset_ProductAssert<SELF extends AbstractA_Asset_ProductAssert<SELF, ACTUAL>, ACTUAL extends X_A_Asset_Product>
	extends AbstractPOAssert<SELF, ACTUAL>
{

    /** Standard Constructor */
    public AbstractA_Asset_ProductAssert (ACTUAL actual, Class<SELF> selfType)
    {
	...
	public SELF hasA_Asset_Product_ID(int expected)
	{
		isNotNull();
	...
	public SELF hasA_Asset_Product_UU(String expected)
	{
		isNotNull();
