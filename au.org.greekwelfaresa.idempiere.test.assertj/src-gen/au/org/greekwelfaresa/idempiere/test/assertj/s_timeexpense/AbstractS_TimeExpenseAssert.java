...
package au.org.greekwelfaresa.idempiere.test.assertj.s_timeexpense;
...
/** Generated assertion class for S_TimeExpense
 *  @author idempiere-test (generated) 
 *  @version Release 6.2 - $Id$ */
@Generated("class au.org.greekwelfaresa.idempiere.test.generator.ModelAssertionGenerator")
public abstract class AbstractS_TimeExpenseAssert<SELF extends AbstractS_TimeExpenseAssert<SELF, ACTUAL>, ACTUAL extends X_S_TimeExpense>
	extends AbstractPOAssert<SELF, ACTUAL>
{

    /** Standard Constructor */
    public AbstractS_TimeExpenseAssert (ACTUAL actual, Class<SELF> selfType)
    {
	...
	public SELF hasDateReport(Object expected)
	{
		isNotNull();
		dateAssert("DateReport", actual.getDateReport(), expected);
		return myself;
	}
	...
	public SELF hasS_TimeExpense_UU(String expected)
	{
		isNotNull();
		String actualField = actual.getS_TimeExpense_UU();
		if (!Objects.equals(expected, actualField)) {
			failWithActualExpectedAndMessage(actualField, expected, "\nExpecting PO: \n  <%s>\n to have S_TimeExpense_UU: <%s>\nbut it was: <%s>",
				getPODescription(), expected, actualField);
		}
		return myself;
	}
