...
package au.org.greekwelfaresa.idempiere.test.assertj.ad_treenodeu2;
...
public abstract class AbstractAD_TreeNodeU2Assert<SELF extends AbstractAD_TreeNodeU2Assert<SELF, ACTUAL>, ACTUAL extends X_AD_TreeNodeU2>
	extends AbstractPOAssert<SELF, ACTUAL>
{

    /** Standard Constructor */
    public AbstractAD_TreeNodeU2Assert (ACTUAL actual, Class<SELF> selfType)
    {
	...
	public SELF hasAD_TreeNodeU2_UU(String expected)
	{
		isNotNull();
