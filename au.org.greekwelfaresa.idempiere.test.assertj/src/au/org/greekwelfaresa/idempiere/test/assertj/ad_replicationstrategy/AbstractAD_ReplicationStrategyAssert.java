...
package au.org.greekwelfaresa.idempiere.test.assertj.ad_replicationstrategy;
...
public abstract class AbstractAD_ReplicationStrategyAssert<SELF extends AbstractAD_ReplicationStrategyAssert<SELF, ACTUAL>, ACTUAL extends X_AD_ReplicationStrategy>
	extends AbstractPOAssert<SELF, ACTUAL>
{

    /** Standard Constructor */
    public AbstractAD_ReplicationStrategyAssert (ACTUAL actual, Class<SELF> selfType)
    {
	...
	public SELF hasAD_ReplicationStrategy_UU(String expected)
	{
		isNotNull();
