...
package au.org.greekwelfaresa.idempiere.test.assertj.ad_treenodecms;
...
public abstract class AbstractAD_TreeNodeCMSAssert<SELF extends AbstractAD_TreeNodeCMSAssert<SELF, ACTUAL>, ACTUAL extends X_AD_TreeNodeCMS>
	extends AbstractPOAssert<SELF, ACTUAL>
{

    /** Standard Constructor */
    public AbstractAD_TreeNodeCMSAssert (ACTUAL actual, Class<SELF> selfType)
    {
	...
	public SELF hasAD_TreeNodeCMS_UU(String expected)
	{
		isNotNull();
