...
package au.org.greekwelfaresa.idempiere.test.assertj.c_payment;
...
public abstract class AbstractC_PaymentAssert<SELF extends AbstractC_PaymentAssert<SELF, ACTUAL>, ACTUAL extends X_C_Payment>
	extends AbstractPOAssert<SELF, ACTUAL>
{

    /** Standard Constructor */
    public AbstractC_PaymentAssert (ACTUAL actual, Class<SELF> selfType)
    {
	...
	public SELF hasC_Payment_UU(String expected)
	{
		isNotNull();
	...
	public SELF hasR_AuthCode_DC(String expected)
	{
		isNotNull();
	...
	public SELF hasR_PnRef_DC(String expected)
	{
		isNotNull();
	...
	public SELF hasRef_Payment_ID(int expected)
	{
		isNotNull();
