...
package au.org.greekwelfaresa.idempiere.test.assertj.ad_modelvalidator;
...
public abstract class AbstractAD_ModelValidatorAssert<SELF extends AbstractAD_ModelValidatorAssert<SELF, ACTUAL>, ACTUAL extends X_AD_ModelValidator>
	extends AbstractPOAssert<SELF, ACTUAL>
{

    /** Standard Constructor */
    public AbstractAD_ModelValidatorAssert (ACTUAL actual, Class<SELF> selfType)
    {
	...
	public SELF hasAD_ModelValidator_UU(String expected)
	{
		isNotNull();
	...
	public SELF hasModelValidationClass(String expected)
	{
		isNotNull();
