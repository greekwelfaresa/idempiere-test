...
package au.org.greekwelfaresa.idempiere.test.assertj.b_topiccategory;
...
public abstract class AbstractB_TopicCategoryAssert<SELF extends AbstractB_TopicCategoryAssert<SELF, ACTUAL>, ACTUAL extends X_B_TopicCategory>
	extends AbstractPOAssert<SELF, ACTUAL>
{

    /** Standard Constructor */
    public AbstractB_TopicCategoryAssert (ACTUAL actual, Class<SELF> selfType)
    {
	...
	public SELF hasB_TopicCategory_UU(String expected)
	{
		isNotNull();
