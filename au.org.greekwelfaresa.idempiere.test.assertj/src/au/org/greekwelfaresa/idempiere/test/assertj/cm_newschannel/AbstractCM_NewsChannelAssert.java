...
package au.org.greekwelfaresa.idempiere.test.assertj.cm_newschannel;
...
public abstract class AbstractCM_NewsChannelAssert<SELF extends AbstractCM_NewsChannelAssert<SELF, ACTUAL>, ACTUAL extends X_CM_NewsChannel>
	extends AbstractPOAssert<SELF, ACTUAL>
{

    /** Standard Constructor */
    public AbstractCM_NewsChannelAssert (ACTUAL actual, Class<SELF> selfType)
    {
	...
	public SELF hasCM_NewsChannel_UU(String expected)
	{
		isNotNull();
	...
	public SELF hasLink(String expected)
	{
		isNotNull();
