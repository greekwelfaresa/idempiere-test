...
package au.org.greekwelfaresa.idempiere.test.assertj.m_storagereservation;
...
public abstract class AbstractM_StorageReservationAssert<SELF extends AbstractM_StorageReservationAssert<SELF, ACTUAL>, ACTUAL extends X_M_StorageReservation>
	extends AbstractPOAssert<SELF, ACTUAL>
{

    /** Standard Constructor */
    public AbstractM_StorageReservationAssert (ACTUAL actual, Class<SELF> selfType)
    {
	...
	public SELF hasM_StorageReservation_UU(String expected)
	{
		isNotNull();
