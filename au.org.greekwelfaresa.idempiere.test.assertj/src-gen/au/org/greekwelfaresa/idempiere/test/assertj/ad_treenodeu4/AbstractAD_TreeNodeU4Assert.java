...
package au.org.greekwelfaresa.idempiere.test.assertj.ad_treenodeu4;
...
public abstract class AbstractAD_TreeNodeU4Assert<SELF extends AbstractAD_TreeNodeU4Assert<SELF, ACTUAL>, ACTUAL extends X_AD_TreeNodeU4>
	extends AbstractPOAssert<SELF, ACTUAL>
{

    /** Standard Constructor */
    public AbstractAD_TreeNodeU4Assert (ACTUAL actual, Class<SELF> selfType)
    {
	...
	public SELF hasAD_TreeNodeU4_UU(String expected)
	{
		isNotNull();
