...
package au.org.greekwelfaresa.idempiere.test.assertj.gl_journalgenerator;
...
public abstract class AbstractGL_JournalGeneratorAssert<SELF extends AbstractGL_JournalGeneratorAssert<SELF, ACTUAL>, ACTUAL extends X_GL_JournalGenerator>
	extends AbstractPOAssert<SELF, ACTUAL>
{

    /** Standard Constructor */
    public AbstractGL_JournalGeneratorAssert (ACTUAL actual, Class<SELF> selfType)
    {
	...
	public SELF hasC_ElementValueAdjustCR_ID(int expected)
	{
		isNotNull();
	...
	public SELF hasC_ElementValueAdjustDR_ID(int expected)
	{
		isNotNull();
	...
	public SELF hasGL_JournalGenerator_UU(String expected)
	{
		isNotNull();
